        ...
        <div className="row top-buffer">
            <div className="alert alert-info text-justify" aria-live="polite" style={{ wordWrap: 'break-word' }}>
                ...
                <p>Los datos personales que se recaban serán utilizados con la finalidad de buscar, generar, validar y obtener
                    el registro de solicitud para apoyos CONAFOR.<br />Conoce nuestro                     {/*<a onclick="ga('send', 'event', 'PDF', 'Descarga', 'AvisoPrivacidad', '1');" href="http://www.conafor.gob.mx/transparencia/docs/AVISO_DE_PRIVACIDAD_INTEGRAL.docx">aviso de privacidad.</a>*/}<a href="https://www.conafor.gob.mx/transparencia/avisoPrivacidad.html" target="_blank"> aviso de
                    privacidad.</a>
                </p>
